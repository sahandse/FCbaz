        ...
        Container(
          ...
          child: const Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'FCBaz شبیه FUTBIN فارسی کار می‌کند: دیتابیس رایگان واقعی بازیکنان همیشه در اپ است؛ قیمت زنده سکه وقتی API عمومی بازار در دسترس باشد نمایش داده می‌شود. داده ساختگی جایگزین نمی‌شود.',
                ),
              ),
            ],
          ),
